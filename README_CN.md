![LOGO](https://gitee.com/zhuyanzhen1/mini-foc/raw/main/image/LOGO.png)
...
### 简介
&nbsp;&nbsp;&nbsp;&nbsp;本仓库是主仓库**miniFOC**用于存放Github Action自动编译固件的仓库，查看源仓库请点击这里：

+ 查看[Github](https://github.com/ZhuYanzhen1/miniFOC)源仓库。
